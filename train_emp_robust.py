...
def get_args():
    ...
    parser.add_argument('--random-restarts', default=10, type=int)
    parser.add_argument('--pgd-eval-steps', default=50, type=int)
    parser.add_argument('--alpha', default=10, type=float, help='Step size')
    parser.add_argument('--delta-init', default='random', choices=['zero', 'random'],
        help='Perturbation initialization method')
    parser.add_argument('--activation', default='swish', choices=['relu', 'swish', 'softplus', 
        'tanh', 'sigmoid'], help='Activation function')
    parser.add_argument('--out-dir', default='emp_robust', type=str, help='Output directory')
